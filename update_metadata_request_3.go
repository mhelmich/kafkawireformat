...
type UpdateMetadataRequest3 struct {
    ControllerId int32
    ControllerEpoch int32
    PartitionStates []*UpdateMetadataRequest3_PartitionStates
    LiveBrokers []*UpdateMetadataRequest3_LiveBrokers
}

func (that *UpdateMetadataRequest3) Encode(enc *Encoder) error {
...
func (that *UpdateMetadataRequest3) Decode(dec *Decoder) error {
    ...
    that.ControllerEpoch = dec.ReadInt32()
    {
        ...
        if int(arrayLength) == -1 {
            ...
            buf := make([]*UpdateMetadataRequest3_PartitionStates, arrayLength)
            var i int32
            for i = 0; i < arrayLength; i++ {
                item := new(UpdateMetadataRequest3_PartitionStates)
                item.Decode(dec)
                buf[i] = item
            }
    ...
    }
    {
        ...
        if int(arrayLength) == -1 {
            ...
            buf := make([]*UpdateMetadataRequest3_LiveBrokers, arrayLength)
            var i int32
            for i = 0; i < arrayLength; i++ {
                item := new(UpdateMetadataRequest3_LiveBrokers)
                item.Decode(dec)
                buf[i] = item
            }
...
type UpdateMetadataRequest3_LiveBrokers struct {
    Id int32
    EndPoints []*UpdateMetadataRequest3_EndPoints
    Rack string
}

func (that *UpdateMetadataRequest3_LiveBrokers) Encode(enc *Encoder) error {
...
func (that *UpdateMetadataRequest3_LiveBrokers) Decode(dec *Decoder) error {
    that.Id = dec.ReadInt32()
    {
        ...
        if int(arrayLength) == -1 {
            ...
            buf := make([]*UpdateMetadataRequest3_EndPoints, arrayLength)
            var i int32
            for i = 0; i < arrayLength; i++ {
                item := new(UpdateMetadataRequest3_EndPoints)
                item.Decode(dec)
                buf[i] = item
            }
            that.EndPoints = buf
...
type UpdateMetadataRequest3_PartitionStates struct {
    Topic string
    Partition int32
    ControllerEpoch int32
    Leader int32
...
func (that *UpdateMetadataRequest3_PartitionStates) Encode(enc *Encoder) error {
...
func (that *UpdateMetadataRequest3_PartitionStates) Decode(dec *Decoder) error {
...
type UpdateMetadataRequest3_EndPoints struct {
    Port int32
    Host string
    ListenerName string
...
func (that *UpdateMetadataRequest3_EndPoints) Encode(enc *Encoder) error {
...
func (that *UpdateMetadataRequest3_EndPoints) Decode(dec *Decoder) error {
