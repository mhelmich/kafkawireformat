...
type LeaderAndIsrRequest0_PartitionStates struct {
    Topic string
    Partition int32
...
func (that *LeaderAndIsrRequest0_PartitionStates) Encode(enc *Encoder) error {
...
func (that *LeaderAndIsrRequest0_PartitionStates) Decode(dec *Decoder) error {
...
type LeaderAndIsrRequest0 struct {
    ControllerId int32
    ControllerEpoch int32
    PartitionStates []*LeaderAndIsrRequest0_PartitionStates
    LiveLeaders []*LeaderAndIsrRequest0_LiveLeaders
}

func (that *LeaderAndIsrRequest0) Encode(enc *Encoder) error {
...
func (that *LeaderAndIsrRequest0) Decode(dec *Decoder) error {
    ...
    that.ControllerEpoch = dec.ReadInt32()
    {
        ...
        if int(arrayLength) == -1 {
            ...
            buf := make([]*LeaderAndIsrRequest0_PartitionStates, arrayLength)
            var i int32
            for i = 0; i < arrayLength; i++ {
                item := new(LeaderAndIsrRequest0_PartitionStates)
                item.Decode(dec)
                buf[i] = item
            }
    ...
    }
    {
        ...
        if int(arrayLength) == -1 {
            ...
            buf := make([]*LeaderAndIsrRequest0_LiveLeaders, arrayLength)
            var i int32
            for i = 0; i < arrayLength; i++ {
                item := new(LeaderAndIsrRequest0_LiveLeaders)
                item.Decode(dec)
                buf[i] = item
            }
...
type LeaderAndIsrRequest0_LiveLeaders struct {
    Id int32
    Host string
    Port int32
}

func (that *LeaderAndIsrRequest0_LiveLeaders) Encode(enc *Encoder) error {
...
func (that *LeaderAndIsrRequest0_LiveLeaders) Decode(dec *Decoder) error {
